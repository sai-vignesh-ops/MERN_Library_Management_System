...
import { Eye, ShieldCheck, CheckCircle2, Download, Search, UserRoundCog, UsersRound } from 'lucide-react';
...
const AdminUsersPage = () => {
    ...
    //to confirm and remove the fine also return the book
                ...
                <div className={s.statsGrid}>
                    {[
                        ...
                        },
                        {
                            ...
                            value: `${
                                studentSummaries.filter((student) => student.activeBooks.length > 0).length
                                }`,
                            icon: UserRoundCog,
                        },
                        {
