import { Sparkles, AlertTriangle, GraduationCap, ReceiptText, BookCopy, IdCard } from "lucide-react"
                ...
                <div className={s.heroGrid}>
                    <div className={s.heroLeft}>
                        ...
                        <p className={s.heroText}>
                            Your Dashboard now keeps the important account summary at the top and sends the most recent issued books directly below for faster access.
                        </p>
                    </div>
                    <div className={s.rightColumnGrid}>
                        <article className={s.profileCard}>
                            ...
                            <div className={s.profileDetails}>
                                ...
                                <div className={s.profileDetailItem}>
                                    Student ID:{currentUserSummary?.studentId ?? "General"}
                                </div>
                            </div>
                        </article>
