...
const Home = () => {
    ...
    return (
        <div className={s.layoutContainer}>
            <Sidebar
                title="shelfWise"
                subtitle="Library managenemt portal"
                        ...
                        <div className={s.heroGrid}>
                            <div>
                                ...
                                <p className={s.heroText}>
                                    This Library management portal gives students a focused borrowing dashboard and gives a practical workspace for manual circulation,user records and overdue tracing.
                                </p>
