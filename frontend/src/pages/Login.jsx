...
import { ShieldCheck, UserRound ,Mail, LockKeyhole, EyeOff, ArrowRight} from 'lucide-react';
const roleChoices = [
...
const Login = () => {
    ...
    // to submit the data to the server and get the user/admin logged-in
                ...
                <section className={s.formPanel}>
                    <div className={s.formInner}>
                        ...
                        <form className={s.form} onSubmit={handleSubmit}>
                            <div className={s.roleContainer}>
                                ...
                                <div className={s.roleGrid}>
                                    {roleChoices.map((choice) => {
                                        ...
                                        return (
                                            <label key={choice.value} className={`${s.roleOption}
                            ...
                            <input type="email" name="email" value={form.email} onChange={handleChange} placeholder="student@cmapus.edu" className={s.input}/>
                        </label>
                        <label className="block">
                         <span className={s.fieldLabel}>
                               <LockKeyhole size={15}/>
                            ...
                            : "password"} 
                            name="password" value={form.password} onChange={handleChange} placeholder="Enter the Password" className={s.passwordInput}/>
                        ...
                        <div className={s.footerFlex}>
                          <span className={s.footerText}>
                            {form.role==="admin" ? "Admin accounts uses existing credentials":"Student signup is available below"}
                          </span>
                          {form.role==="user" && (
